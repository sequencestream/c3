...
| 关注点           | 决策                                                                                                                                                                                                                                                                                                                     |
| ---------------- | ------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------ |
| 通用契约         | `GenericEvent`（`type` 必填非空判别值 + `status`/`description` + 扁平 `metadata` + JSON `data`）与 `GenericEventEnvelope` 定义在 `shared/src/protocol.ts`；`validateGenericEvent` 拒绝空 type、嵌套 metadata、非 JSON `data`。                                                                                           |
