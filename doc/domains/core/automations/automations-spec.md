...
`{ matched, breakdown }`, keeping the match semantics isolated from the dispatch plumbing. Each survivor dispatches through the normal dispatch-and-track
