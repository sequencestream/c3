...
| [codes](codes/codes-overview.md)                                        | Read-only workspace code browsing: list directories, read text files, and bounded search under a registered workspace root                                                   | WebSocket `/ws` (see shared protocol) | active        |
