...
- **Claude Agent SDK** —— 沟通智能体使用一个禁用工具列表、一段追加的系统 prompt 预设;c3 自己的
  `c3` 工具面(`save_intents` 写入需确认,加只读的 `find_intents` / `view_intent` 查询工具,RM-R19)
