...
export const handlerMap: HandlerMap = {
  ...
  start_intent_relay: startIntentRelay,
  set_intent_spec_mode: setIntentSpecMode,
  set_intent_impact_level: setIntentImpactLevel,
  ...
  start_app_registration: startAppRegistrationHandler,
  cancel_app_registration: cancelAppRegistrationHandler,
}
