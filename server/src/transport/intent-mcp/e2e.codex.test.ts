    ...
    const code = await new Promise<number | null>((resolve, reject) => {
      const child = spawn(
        ...
        [
          ...
          '-c',
          'mcp_servers.c3.enabled=true',
          '-c',
          'mcp_servers.c3.required=true',
          '-c',
          'mcp_servers.c3.enabled_tools=["find_intents","view_intent","save_intents"]',
          '-c',
          'mcp_servers.c3.default_tools_approval_mode="approve"',
