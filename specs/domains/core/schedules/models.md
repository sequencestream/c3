...
| `vendor`            | enum `claude \| codex \| opencode`           | Vendor this schedule belongs to; determines which agent runs it at execution time. Defaults to `claude` for legacy rows (2026-06-08).                                                                                                                                                                                       |
