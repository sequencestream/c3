...
| SessionStatusBar  | `components/SessionStatusBar.vue`          | Thin status line above the input: run-activity dot + spinner + label + Stop button (red square) + refresh button; presentational, emits `refresh` and `stop`. The Stop button is enabled while `running \|\| teamActive` (its `title` distinguishes stop-turn vs end-team) and routes to `stopRun` (WC-R14/R15)                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                  |
...
| SettingsPanel     | `components/SettingsPanel.vue`             | System settings page: agent table + consensus toggle; owns editable draft seeded from server settings. The agent table's icon column is a manual text input paired with an `EmojiPicker` (both `v-model` the same `a.icon` draft field)                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                          |
