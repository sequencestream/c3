...
| `currentWorkspaceSetting` | `ProjectConfig \| null`                      | The last `project_config` reply from the server, seeded into WorkspaceSettingPage's draft. Cleared on workspace switch and WS reconnect                                                                                                                                                           |
...
| `project_config`           | set `currentWorkspaceSetting` to the returned config; consumed by WorkspaceSettingPage's draft watcher                                             |
...
| `openWorkspaceSetting()`                       | workspace selected                                                                                    | opens WorkspaceSettingPage overlay; sends `load_project_config` for the current workspace                                                                                                                                                                  |
| `saveWorkspaceSetting(config)`                 | workspace selected                                                                                    | sends `save_project_config` with the project path and edited config; closes WorkspaceSettingPage                                                                                                                                                           |
