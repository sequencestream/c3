...
entities — they exist only in the browser. Behavioral wiring in [design.md](design.md).
...
path); client consumption is in [design.md](design.md) _Task-list (wire-driven)_.
...
(grouping / completed-truncation / visibility — see [design.md](design.md) \_Task panel*). Since
