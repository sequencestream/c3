...
| WC-R14 | While the viewed ordinary session is running, a Stop button (sends `stop_run`) shows alongside the Send button (which enqueues, WC-R17); switching sessions never stops a run.                                                                                                                                                                                                                                                                                                                                                                                                                                                                                        |
...
- **Running (viewed session)** — the viewed session's `session_status` is not `idle`; the
  composer stays editable, the Stop button shows, and Send enqueues rather than submits
  (WC-R2, WC-R14, WC-R17).
