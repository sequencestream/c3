...
| [activation & entitlement](flow-activation-and-entitlement.md)       | A buyer purchases and activates; heartbeats keep the install entitled; lapse gates only new-session creation | product-license · web-console · session-registry · license-server                        |
