...
| [`requirement-management`](domains/core/requirement-management/) | A project-scoped requirement ledger and a read-only requirement-communication agent that breaks ideas into verifiable items and launches `/develop-pipeline` |
