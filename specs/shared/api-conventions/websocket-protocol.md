...
| `discussions`        | `projectPath: string`, `items: Discussion[]`                                                                        | A project's discussion list, in reply to `list_discussions` (or pushed after a change). Drives the discussion-view left list.                                                                                                                                                                                                                                                                                                                                               |
...
`open_discussion` returns the full ordered history at once (`discussion_detail`); R1 has no live
discussion session, so the right pane is read-only. See the
