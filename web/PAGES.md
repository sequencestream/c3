...
│   │   ├── components/
│   │   │   │   # IntentDetail 删除入口位于标题栏操作区最右侧:所有状态(含 done)均显示 danger ConfirmDialog,in_progress/done 强化工作产物提示,确认后 emit delete。
