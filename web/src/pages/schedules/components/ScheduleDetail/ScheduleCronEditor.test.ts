...
function mountEditor(
  props: Partial<{ open: boolean; schedule: Schedule | null; cronExpression: string }> = {},
) {
  return mount(ScheduleCronEditor, {
    props: { open: true, schedule: null, ...props },
  })
}

const freqSelect = '.sce-body select.sce-input'

describe('ScheduleCronEditor.vue — 修改时间弹框', () => {
